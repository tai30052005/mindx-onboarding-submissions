...
một**. Chỗ nhiều người hiểu nhầm là tưởng nó có hai pha: viết hết test rồi mới sang
viết code.
...
Thứ buộc code tổng quát hoá là test kế tiếp. Trực giác của người viết không tính.
...
Test có được sửa ở bước này không? Được, nhưng chỉ sửa cấu trúc của nó, kiểu đổi tên,
...
bị bỏ sót là những trường hợp code hiện tại chưa xử lý, mà bug thì nằm đúng ở đó:
chỗ code làm một đằng còn yêu cầu đòi một nẻo.
...
test sau thì câu hỏi đó không bắt buộc phải trả lời, vì code đã chạy rồi, và luôn có
đường vòng.
...
chọn tiêm vì một lý do cụ thể của bài này, là tuần 3 phải hoán đổi implementation, chứ
...
Và trong bối cảnh tuần 1, khi code do AI sinh, lập luận đổi hẳn cường độ. Để AI viết
