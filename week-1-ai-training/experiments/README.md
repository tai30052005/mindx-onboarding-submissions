...
| `speed/` | Unit test và integration test thật sự chênh nhau bao nhiêu | Unit 0.05–0.11ms, integration ghi/đọc file thật 1.1–2.5ms, khởi động tiến trình ~88ms. Bác bỏ lập luận "integration chậm nên giết vòng lặp TDD" và làm đổi tỷ lệ đề xuất trong `02` từ 70/25/5 sang 50/45/5 |
