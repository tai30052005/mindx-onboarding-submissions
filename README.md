...
Not part of `docs/plans/`, but required by the training slides.

| Assignment | Source | Location | Done |
|---|---|---|---|
| CV revision (FAANGPath LaTeX template) | `slides-cv-interview-tips.md` | `extras/cv/` | ☐ |
| Learning plan (1-year target, 3 skills) | `slides-lifetime-learning.md` | [extras/learning-plan.md](extras/learning-plan.md) | ☐ |
